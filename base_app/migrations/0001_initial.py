    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Full name of author', max_length=200, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_copy_type', models.CharField(blank=True, choices=[('pb', 'PAPERBACK'), ('hc', 'HARDCOVER'), ('hm', 'HANDMADE'), ('nd', 'NOTDEFINED')], default='nd', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('library_user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
